...
const (
	...
	Bonus2WS BonusSquare = 1
	// Bonus3WS is a triple word score
	Bonus3WS BonusSquare = 2

	// Bonus2LS is a double letter score
	Bonus2LS BonusSquare = 11
	// Bonus3LS is a triple letter score
	Bonus3LS BonusSquare = 12

	NoBonus BonusSquare = 0
)

func (b BonusSquare) String() string {
	switch b {
	case Bonus3WS:
		return "="
	case Bonus3LS:
...
func toBonusSquare(r rune) BonusSquare {
	switch r {
	case '=':
		return Bonus3WS
	case '"':
