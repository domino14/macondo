...
func (GameEvent_Type) EnumDescriptor() ([]byte, []int) {
	return file_api_proto_macondo_macondo_proto_rawDescGZIP(), []int{2, 0}
}
...
func (GameEvent_Direction) EnumDescriptor() ([]byte, []int) {
	return file_api_proto_macondo_macondo_proto_rawDescGZIP(), []int{2, 1}
}
...
type GameState struct {
	...
	Board          *GameState_GameBoard `protobuf:"bytes,1,opt,name=board,proto3" json:"board,omitempty"`
	Bag            *GameState_GameBag   `protobuf:"bytes,2,opt,name=bag,proto3" json:"bag,omitempty"`
	ScorelessTurns int32                `protobuf:"varint,3,opt,name=scoreless_turns,json=scorelessTurns,proto3" json:"scoreless_turns,omitempty"`
	Onturn         int32                `protobuf:"varint,4,opt,name=onturn,proto3" json:"onturn,omitempty"`
	History        *GameHistory         `protobuf:"bytes,5,opt,name=history,proto3" json:"history,omitempty"`
}
...
func (x *GameState) GetBoard() *GameState_GameBoard {
	if x != nil {
		return x.Board
	}
	return nil
...
func (x *GameState) GetBag() *GameState_GameBag {
	if x != nil {
		return x.Bag
	}
	return nil
...
func (x *GameState) GetScorelessTurns() int32 {
	if x != nil {
...
func (x *GameState) GetOnturn() int32 {
	if x != nil {
		return x.Onturn
	}
	return 0
...
func (x *GameState) GetHistory() *GameHistory {
	if x != nil {
		return x.History
	}
	return nil
...
type GameState_GameBag struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Tiles              map[int32]int32 `protobuf:"bytes,1,rep,name=tiles,proto3" json:"tiles,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	NumTiles           int32           `protobuf:"varint,2,opt,name=numTiles,proto3" json:"numTiles,omitempty"`
	PcgrState          uint64          `protobuf:"varint,3,opt,name=pcgr_state,json=pcgrState,proto3" json:"pcgr_state,omitempty"`
	PcgrInc            uint64          `protobuf:"varint,4,opt,name=pcgr_inc,json=pcgrInc,proto3" json:"pcgr_inc,omitempty"`
	UniqueTiles        []byte          `protobuf:"bytes,5,opt,name=unique_tiles,json=uniqueTiles,proto3" json:"unique_tiles,omitempty"`
	LetterDistribution string          `protobuf:"bytes,6,opt,name=letter_distribution,json=letterDistribution,proto3" json:"letter_distribution,omitempty"`
}

func (x *GameState_GameBag) Reset() {
	*x = GameState_GameBag{}
	if protoimpl.UnsafeEnabled {
...
func (x *GameState_GameBag) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GameState_GameBag) ProtoMessage() {}

func (x *GameState_GameBag) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_macondo_macondo_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GameState_GameBag.ProtoReflect.Descriptor instead.
func (*GameState_GameBag) Descriptor() ([]byte, []int) {
	return file_api_proto_macondo_macondo_proto_rawDescGZIP(), []int{1, 0}
}

func (x *GameState_GameBag) GetTiles() map[int32]int32 {
	if x != nil {
		return x.Tiles
	}
	return nil
...
func (x *GameState_GameBag) GetNumTiles() int32 {
	if x != nil {
		return x.NumTiles
	}
	return 0
...
func (x *GameState_GameBag) GetPcgrState() uint64 {
	if x != nil {
		return x.PcgrState
	}
	return 0
...
func (x *GameState_GameBag) GetPcgrInc() uint64 {
	if x != nil {
		return x.PcgrInc
	}
	return 0
...
func (x *GameState_GameBag) GetUniqueTiles() []byte {
	if x != nil {
		return x.UniqueTiles
	}
	return nil
}

func (x *GameState_GameBag) GetLetterDistribution() string {
	if x != nil {
...
type GameState_GameBoard struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Dim          int32  `protobuf:"varint,1,opt,name=dim,proto3" json:"dim,omitempty"`
	BoardLetters []byte `protobuf:"bytes,2,opt,name=board_letters,json=boardLetters,proto3" json:"board_letters,omitempty"`
	BoardBonuses string `protobuf:"bytes,3,opt,name=board_bonuses,json=boardBonuses,proto3" json:"board_bonuses,omitempty"`
	...
	HCrossScores []int32 `protobuf:"varint,4,rep,packed,name=h_cross_scores,json=hCrossScores,proto3" json:"h_cross_scores,omitempty"`
	VCrossScores []int32 `protobuf:"varint,5,rep,packed,name=v_cross_scores,json=vCrossScores,proto3" json:"v_cross_scores,omitempty"`
	TilesPlayed  int32   `protobuf:"varint,6,opt,name=tiles_played,json=tilesPlayed,proto3" json:"tiles_played,omitempty"`
}

func (x *GameState_GameBoard) Reset() {
	*x = GameState_GameBoard{}
	if protoimpl.UnsafeEnabled {
...
func (x *GameState_GameBoard) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GameState_GameBoard) ProtoMessage() {}

func (x *GameState_GameBoard) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_macondo_macondo_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GameState_GameBoard.ProtoReflect.Descriptor instead.
func (*GameState_GameBoard) Descriptor() ([]byte, []int) {
	return file_api_proto_macondo_macondo_proto_rawDescGZIP(), []int{1, 1}
}

func (x *GameState_GameBoard) GetDim() int32 {
	if x != nil {
		return x.Dim
	}
	return 0
...
func (x *GameState_GameBoard) GetBoardLetters() []byte {
	if x != nil {
		return x.BoardLetters
	}
	return nil
}

func (x *GameState_GameBoard) GetBoardBonuses() string {
	if x != nil {
		return x.BoardBonuses
	}
	return ""
}

func (x *GameState_GameBoard) GetHCrossScores() []int32 {
	if x != nil {
		return x.HCrossScores
	}
	return nil
}

func (x *GameState_GameBoard) GetVCrossScores() []int32 {
	if x != nil {
		return x.VCrossScores
	}
	return nil
}

func (x *GameState_GameBoard) GetTilesPlayed() int32 {
	if x != nil {
...
var file_api_proto_macondo_macondo_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x07, 0x6d, 0x61, 0x63, 0x6f, 0x6e, 0x64, 0x6f, 0x22, 0xa7, 0x04, 0x0a, 0x0b, 0x47,
	...
	,
	...
	,
	...
	0x69, 0x63, 0x6b, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x72, 0x65, 0x61, 0x6c, 0x5f,
	...
	,
	...
	0x65, 0x2a, 0x43, 0x0a, 0x09, 0x50, 0x6c, 0x61, 0x79, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x0b,
	...
	0x4f, 0x56, 0x45, 0x52, 0x10, 0x02, 0x2a, 0x50, 0x0a, 0x0d, 0x43, 0x68, 0x61, 0x6c, 0x6c, 0x65,
	...
	0x5f, 0x50, 0x4f, 0x49, 0x4e, 0x54, 0x10, 0x04, 0x42, 0x33, 0x5a, 0x31, 0x67, 0x69, 0x74, 0x68,
...
var file_api_proto_macondo_macondo_proto_goTypes = []interface{}{
	...
	(*GameState)(nil),           // 5: macondo.GameState
	(*GameEvent)(nil),           // 6: macondo.GameEvent
	(*PlayerInfo)(nil),          // 7: macondo.PlayerInfo
	(*BotRequest)(nil),          // 8: macondo.BotRequest
	(*BotResponse)(nil),         // 9: macondo.BotResponse
	(*GameState_GameBag)(nil),   // 10: macondo.GameState.GameBag
	(*GameState_GameBoard)(nil), // 11: macondo.GameState.GameBoard
	nil,                         // 12: macondo.GameState.GameBag.TilesEntry
}
var file_api_proto_macondo_macondo_proto_depIdxs = []int32{
	...
	11, // 4: macondo.GameState.board:type_name -> macondo.GameState.GameBoard
	10, // 5: macondo.GameState.bag:type_name -> macondo.GameState.GameBag
	4,  // 6: macondo.GameState.history:type_name -> macondo.GameHistory
	2,  // 7: macondo.GameEvent.type:type_name -> macondo.GameEvent.Type
	3,  // 8: macondo.GameEvent.direction:type_name -> macondo.GameEvent.Direction
	4,  // 9: macondo.BotRequest.game_history:type_name -> macondo.GameHistory
	6,  // 10: macondo.BotResponse.move:type_name -> macondo.GameEvent
	12, // 11: macondo.GameState.GameBag.tiles:type_name -> macondo.GameState.GameBag.TilesEntry
...
func file_api_proto_macondo_macondo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_proto_macondo_macondo_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GameState_GameBag); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_proto_macondo_macondo_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GameState_GameBoard); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_api_proto_macondo_macondo_proto_msgTypes[5].OneofWrappers = []interface{}{
