...
type AutoplayPlayerConfig struct {
	...
	// endgame_threads sets the number of threads used inside a single endgame
	// solve. If 0, defaults to max(1, NumCPU / autoplay_threads).
	EndgameThreads int32 `protobuf:"varint,13,opt,name=endgame_threads,json=endgameThreads,proto3" json:"endgame_threads,omitempty"`
	// preendgame_threads sets the number of threads used inside a single
	// pre-endgame solve. If 0, defaults to max(1, NumCPU / autoplay_threads).
	PreendgameThreads int32 `protobuf:"varint,15,opt,name=preendgame_threads,json=preendgameThreads,proto3" json:"preendgame_threads,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *AutoplayPlayerConfig) GetEndgameThreads() int32 {
	if x != nil {
		return x.EndgameThreads
	}
	return 0
}

func (x *AutoplayPlayerConfig) GetPreendgameThreads() int32 {
	if x != nil {
		return x.PreendgameThreads
	}
	return 0
}
...
const file_api_proto_macondo_macondo_proto_rawDesc = "" +
	...
	"\rmissed_bingos\x18\f \x01(\x05R\fmissedBingos\"\xba\x05\n" +
	...
	"\x14external_engine_args\x18\x0e \x03(\tR\x12externalEngineArgs\x12'\n" +
	"\x0fendgame_threads\x18\r \x01(\x05R\x0eendgameThreads\x12-\n" +
	"\x12preendgame_threads\x18\x0f \x01(\x05R\x11preendgameThreads\"\xea\x03\n" +
