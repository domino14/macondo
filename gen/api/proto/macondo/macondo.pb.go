...
func (x *AutoplayPlayerConfig) GetQuickEndgamePlies() int32 {
	if x != nil {
		return x.QuickEndgamePlies
	}
	return 0
}

func (x *AutoplayPlayerConfig) GetQuickEndgameMargin() int32 {
	if x != nil {
		return x.QuickEndgameMargin
	}
	return 0
}
...
type AutoplayConfig struct {
	...
	GamePairs bool `protobuf:"varint,14,opt,name=game_pairs,json=gamePairs,proto3" json:"game_pairs,omitempty"`
...
func (x *AutoplayConfig) GetGamePairs() bool {
	if x != nil {
		return x.GamePairs
	}
	return false
...
const file_api_proto_macondo_macondo_proto_rawDesc = "" +
	...
	"\auser_id\x18\x03 \x01(\tR\x06userId\"\x96\x06\n" +
	"\n" +
	"BotRequest\x127\n" +
	...
	"\x10millis_remaining\x18\x04 \x01(\x05R\x0fmillisRemaining\"\xa0\x04\n" +
	"\aBotCode\x12\r\n" +
	...
	"\x18SIMMING_WITH_ML_EVAL_BOT\x10\x10\x12\x15\n" +
	"\x11SIMMING_BOT_NO_EG\x10\x11\x12\x1b\n" +
	"\x17SIMMING_INFER_BOT_NO_EG\x10\x12\x12\x0e\n" +
	"\n" +
	"CUSTOM_BOT\x10\x14\x12\x1d\n" +
	"\x19COMMON_WORD_PLUS_TWOS_BOT\x10\x15\x12\v\n" +
	"\aUNKNOWN\x10d\"'\n" +
	...
	"\bresponse\"\xe4\b\n" +
	"\vPuzzleStats\x12!\n" +
	"\fwords_formed\x18\x01 \x01(\x05R\vwordsFormed\x12(\n" +
	"\x10main_word_length\x18\x02 \x01(\x05R\x0emainWordLength\x12!\n" +
	"\ftiles_played\x18\x03 \x01(\x05R\vtilesPlayed\x12\x14\n" +
	"\x05score\x18\x04 \x01(\x05R\x05score\x12)\n" +
	"\x10equity_advantage\x18\x05 \x01(\x01R\x0fequityAdvantage\x12'\n" +
	"\x0fscore_advantage\x18\x06 \x01(\x05R\x0escoreAdvantage\x12<\n" +
	"\x1btop_score_play_tiles_played\x18\a \x01(\x05R\x17topScorePlayTilesPlayed\x12\x1f\n" +
	"\vtws_covered\x18\b \x01(\x05R\n" +
	"twsCovered\x12\x1f\n" +
	"\vdws_covered\x18\t \x01(\x05R\n" +
	"dwsCovered\x12\x1f\n" +
	"\vdls_covered\x18\n" +
	" \x01(\x05R\n" +
	"dlsCovered\x12\x1f\n" +
	"\vtls_covered\x18\v \x01(\x05R\n" +
	"tlsCovered\x122\n" +
	"\x15bonus_squares_covered\x18\f \x01(\x05R\x13bonusSquaresCovered\x121\n" +
	"\x15max_cross_word_length\x18\r \x01(\x05R\x12maxCrossWordLength\x121\n" +
	"\x15min_cross_word_length\x18\x0e \x01(\x05R\x12minCrossWordLength\x12;\n" +
	"\x1alongest_hooked_word_length\x18\x0f \x01(\x05R\x17longestHookedWordLength\x12?\n" +
	"\x1clongest_extended_word_length\x18\x10 \x01(\x05R\x19longestExtendedWordLength\x12@\n" +
	"\x1dmax_played_through_tile_score\x18\x11 \x01(\x05R\x19maxPlayedThroughTileScore\x12q\n" +
	"8max_fresh_tile_face_value_on_letter_bonus_with_crossword\x18\x12 \x01(\x05R/maxFreshTileFaceValueOnLetterBonusWithCrossword\x12-\n" +
	"\x13max_rack_tile_score\x18\x13 \x01(\x05R\x10maxRackTileScore\x12D\n" +
	" max_fresh_tile_face_value_on_tls\x18\x14 \x01(\x05R\x1amaxFreshTileFaceValueOnTls\x12D\n" +
	" max_fresh_tile_face_value_on_dls\x18\x15 \x01(\x05R\x1amaxFreshTileFaceValueOnDls\x121\n" +
	"\x15total_rack_tile_score\x18\x16 \x01(\x05R\x12totalRackTileScore\"\xf5\x01\n" +
	...
	"\fbucket_index\x18\x05 \x01(\x05R\vbucketIndex\x12*\n" +
	"\x05stats\x18\x06 \x01(\v2\x14.macondo.PuzzleStatsR\x05stats\"\x98\x01\n" +
	...
	"\bexcludes\x18\x04 \x03(\x0e2\x12.macondo.PuzzleTagR\bexcludes\"\x92\x01\n" +
	"\x17PuzzleGenerationRequest\x12/\n" +
	"\abuckets\x18\x01 \x03(\v2\x15.macondo.PuzzleBucketR\abuckets\x12#\n" +
	"\requity_margin\x18\x02 \x01(\x01R\fequityMargin\x12!\n" +
	"\fscore_margin\x18\x03 \x01(\x01R\vscoreMargin\"\x97\x03\n" +
	...
	"\bCEL_ONLY\x10\a\x12\n" +
	"\n" +
	"\x06POINTS\x10\b\x12\x11\n" +
	"\rCEL_PLUS_TWOS\x10\t*j\n" +
