...
func TestPlayerNames(t *testing.T) {
	...
	is.Equal(playerNames([]AutomaticRunnerPlayer{
		{"", "", macondo.BotRequest_HASTY_BOT, nil, 0, false},
		{"", "", macondo.BotRequest_HASTY_BOT, nil, 0, false},
	...
	is.Equal(playerNames([]AutomaticRunnerPlayer{
		{"", "", macondo.BotRequest_HASTY_BOT, nil, 0, false},
		{"", "", macondo.BotRequest_NO_LEAVE_BOT, nil, 0, false},
		{"", "", macondo.BotRequest_HASTY_BOT, nil, 0, false},
	...
	is.Equal(playerNames([]AutomaticRunnerPlayer{
		{"", "", macondo.BotRequest_LEVEL1_COMMON_WORD_BOT, nil, 0, false},
		{"", "", macondo.BotRequest_LEVEL3_COMMON_WORD_BOT, nil, 0, false},
